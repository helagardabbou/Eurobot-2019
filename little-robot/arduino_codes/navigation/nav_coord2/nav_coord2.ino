...
void rotation (const geometry_msgs::Point& rotation_msg){
  rotation(rotation_msg.x);
}
...
void stopUSFrontLeft( const sensor_msgs::Range& stop_us_fl_msg){
  if ((quadran==3||quadran==2)&&(10<stop_us_fl_msg.range < 20.00)) {
    sensor=true;
  }
  else{
    sensor=false;
...
void stopUSFrontRight( const sensor_msgs::Range& stop_us_fr_msg){
  if ((quadran==1||quadran==3)&&(10<stop_us_fr_msg.range < 20.00)) {
    sensor=true;
  }
  else{
    sensor=false;
...
void stopUSLeft( const sensor_msgs::Range& stop_us_l_msg){
  if ((quadran==3||quadran==4)&&(10<stop_us_l_msg.range < 20.00)) {
    sensor=true;
  }
  else{
    sensor=false;
...
void stopUSRight( const sensor_msgs::Range& stop_us_r_msg){
  if ((quadran==1||quadran==6)&&(10<stop_us_r_msg.range < 20.00)) {
    sensor=true;
  }
  else{
    sensor=false;
...
void stopUSRearLeft( const sensor_msgs::Range& stop_us_rl_msg){
  if ((quadran==4||quadran==5)&&(10<stop_us_rl_msg.range < 20.00)) {
    sensor=true;
  }
  else{
    sensor=false;
...
void stopUSRearRight( const sensor_msgs::Range& stop_us_rr_msg){
  if ((quadran==5||quadran==6)&&(10<stop_us_rr_msg.range < 20.00)) {
    sensor=true;
  }
  else{
    sensor=false;
...
void stopButtonFrontLeft( const std_msgs::Bool& stop_button_fl_msg){
  if (stop_button_fl_msg.data) {
  }
}


void stopButtonFrontRight( const std_msgs::Bool& stop_button_fr_msg){
  if (stop_button_fr_msg.data) {

  }
}


void stopButtonLeft( const std_msgs::Bool& stop_button_l_msg){
  if (stop_button_l_msg.data) {

  }
}


void stopButtonRight( const std_msgs::Bool& stop_button_r_msg){
  if (stop_button_r_msg.data) {

  }
}


void stopButtonRearLeft( const std_msgs::Bool& stop_button_rl_msg){
  if (stop_button_rl_msg.data) {

  }
}


void stopButtonRearRight( const std_msgs::Bool& stop_button_rr_msg){
  if (stop_button_rr_msg.data) {
...
ros::Subscriber<std_msgs::Bool> sub8("button0", &stopButtonFrontLeft );
ros::Subscriber<std_msgs::Bool> sub9("button1", &stopButtonFrontRight );
ros::Subscriber<std_msgs::Bool> sub10("button2", &stopButtonLeft );
ros::Subscriber<std_msgs::Bool> sub11("button3", &stopButtonRight );
ros::Subscriber<std_msgs::Bool> sub12("button4", &stopButtonRearLeft );
ros::Subscriber<std_msgs::Bool> sub13("button5", &stopButtonRearLeft );
ros::Subscriber<geometry_msgs::Point> sub14("rotate_instructions", &rotation );
