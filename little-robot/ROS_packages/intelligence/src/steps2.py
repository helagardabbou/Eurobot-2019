    ...
    if data.data == True:
        ...
        if step == 1:
            if left == 1:
                ...
                go_to(0, 30) # To get around the two pucks

        if step == 2:
            go_to(-60, 0) # To over step the pucks

        if step == 3:
            if left == 1:
                go_to(0, 15)
            else:
                go_to(0, -15) # To go in front of the first puck

        if step == 4:
            go_to(30, 0) # To place the first puck in the box

        if step == 5:
            go_to(-30, 0) # To go back

        if step == 6:
            if left == 1:
                go_to(0, -30)
            else:
                go_to(0, 30) # To go in front of the second puck

        if step == 7:
            go_to(30, 0) # To place the second puck in the box
        ...
        if step == 9:
            if left == 1:
            	go_to(0, y) # To go in front of the slide
            else:
                go_to(0, -y)

        if step == 10:
            go_to(100, 0) # The climb
